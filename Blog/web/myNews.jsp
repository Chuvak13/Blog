...
<%
    ...
    ArrayList<News> newslist= (ArrayList<News>) DbManagerNews.getAllNewsById(currentUser.getId());
...
%>
        ...
        <div class="list-group-item list-group-item-action active m-2 bg-warning text-dark">
            ...
            <a href="/CommentsServlet?blogId=<%=news.getId()%>"style="text-decoration: none" class="text-dark">Комментарии</a>
